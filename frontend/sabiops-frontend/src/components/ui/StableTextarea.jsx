/**
 * StableTextarea - Textarea component that preserves focus during re-renders
 * Addresses the issue where textarea fields lose focus after typing single characters
 */
...
const StableTextarea = React.forwardRef(({
  onChange,
  onFocus,
  onBlur,
  className,
  componentName = 'StableTextarea',
  preserveFocus = true,
  logEvents = true,
  ...props
}, ref) => {
